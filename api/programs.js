...
function defaultBlocks() {
  return [
    ...
    { id: 'basic_info', type: 'text', title: 'Basic Information', content: 'Introduce your Service Learning project here.', width: 100, minHeight: 180, bg: '#ffffff', text: '#172e5c', fontFamily: 'Arial', fontSize: 16, align: 'left', borderEnabled: true, borderColor: '#d9dee7', borderWidth: 1, backgroundImage: '' },
    { id: 'signup', type: 'signup', title: 'How to Sign Up', content: 'Explain how students can join or help.', linkLabel: 'Sign up', linkUrl: '', width: 50, minHeight: 180, bg: '#ffffff', text: '#172e5c', fontFamily: 'Arial', fontSize: 16, align: 'left', borderEnabled: true, borderColor: '#d9dee7', borderWidth: 1, backgroundImage: '' },
    { id: 'news_intro', type: 'text', title: 'News', content: 'Latest project updates appear below.', width: 50, minHeight: 180, bg: '#fff0f2', text: '#172e5c', fontFamily: 'Arial', fontSize: 16, align: 'left', borderEnabled: false, borderColor: '#e54555', borderWidth: 1, backgroundImage: '' }
  ];
}
